    ...
    return (
        <div>
            <div className={classes.root}>
                ...
                <Grid container className={classes.grid} direction='row' spacing={10}>
                ...
                <Grid container className={classes.grid} direction='row'            >
                    <Grid item xs={12}>
                        <Grid container justify="center" >
                            ...
                            <Grid item md={3}>
                                <ZImageDisplay imageUral={'http://groundstandards.com/wp-content/uploads/computer-check-300x251.png'} />
                            </Grid>
                            <Grid item xs={3}>
                                <ZImageDisplay classesName={classes.image} imageUral={'http://groundstandards.com/wp-content/uploads/survey-check-300x200.png'} />
                            </Grid>
                            <Grid item xs={3}>
