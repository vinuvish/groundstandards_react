            ...
            <Grid item xs={12} className={classes.grid}>
                <Grid container justify="center" spacing={10}>
                    ...
                    <Grid item>
                        ...
                        <Card className={classes.image} classes={{ root: state.raised3 ? classes.cardHovered : "" }}
                            onMouseOver={() => setState({
                                raised1: false, raised2: false,
                                raised3: true, shadow: 3
                            })}
                            onMouseOut={() => setState({
                                raised1: false, raised2: false,
                                raised3: false, shadow: 1
            ...
            <Grid item xs={12} className={classes.grid}>
                <Grid container justify="center" spacing={10}>
                    <Grid item>
                        ...
                        <img src="http://groundstandards.com/wp-content/uploads/the-only-3rd-party-audit-program-check900x118-800x105.png" alt="" />

                    </Grid>
                    <Grid item>


                        <img src="http://groundstandards.com/wp-content/uploads/check-yes-and-no-green400x370.png" alt="" />
